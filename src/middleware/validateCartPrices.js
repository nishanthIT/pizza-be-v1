  ...
  try {
    ...
    for (const item of localItems) {
      if (item.isCombo) {
        ...
        console.log(`Validated item: ${pizza.name}, Size: ${size}, Quantity: ${quantity}, Price: ${finalPrice} (Base: ${basePrice}, Ingredients: +${ingredientsTotalPrice.toFixed(2)}, Toppings: +${toppingsTotalPrice.toFixed(2)})`);
      }
    }
